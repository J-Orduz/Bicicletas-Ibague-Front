...
const Hyperspeed = ({
  ...
  useEffect(() => {
    if (appRef.current) {
      ...
      const container = document.getElementById("lights-landing");
      if (container) {
    ...
    (function () {
      ...
      // Merge defaults with provided effectOptions so nested values (like colors) are present
      const baseDefaults = {
        onSpeedUp: () => {},
        onSlowDown: () => {},
        distortion: "turbulentDistortion",
      ...
      const options = Object.assign({}, baseDefaults, effectOptions || {});
      // ensure nested colors object merges too
      options.colors = Object.assign(
        {},
        baseDefaults.colors,
        (effectOptions && effectOptions.colors) || {}
      );
  ...
  return <div id="lights-landing" ref={hyperspeed}></div>;
};
